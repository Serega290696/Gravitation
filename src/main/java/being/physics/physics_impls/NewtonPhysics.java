...
import being.physics.LifeCycleStatus;
import being.physics.MetricsPhysics;
...
//            if (updatedAtom != null) {
//                if (updatedAtom.getClass() == Rocket.class) {
//                    System.out.println("rocket");
//                    Rocket rocket = (Rocket) updatedAtom;
//                    rocket.update(power);
//                } else {
//                    updatedAtom.update(power);
//                }
