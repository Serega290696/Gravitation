...
//    public static double MOMENT_DURATION = 1;
    public static double MOMENT_DURATION = 0.0002;
    ...
    public static class NewtonPhysicsConfigurations extends PhysicsConfigurations {
        ...
        //        public static double G = 6.67d*Math.pow(10, 0);// G = 10^-11 - truth value. But I use 'km' instead 'm'
...
//        public static double G = 9d * Math.pow(10, -6);
        public static boolean IS_GRAVITY_ENABLE = true;
        public static boolean IS_ELECTROMAGNETISM_ENABLE = false;
        public static boolean DRAW_SIMPLE_SHAPES = true;
    }
